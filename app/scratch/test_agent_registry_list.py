...
# Add extra_pkgs and adk to path
sys.path.insert(0, "/usr/local/google/home/manishkgaur/Desktop/Workspace/Agent-gateway/extra_pkgs")
sys.path.insert(0, "/usr/local/google/home/manishkgaur/Desktop/Workspace/Agent-gateway/extra_pkgs/google/adk")
...
try:
    ...
    print(f"pydantic attributes: {dir(pydantic)}")
