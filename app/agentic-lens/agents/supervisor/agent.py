...
"""
Supervisor agent — simplified for QA (no Agent Gateway patching).
Loads root_agent from src.router.
"""
import os
import sys

# Add the staged package to path
_here = os.path.dirname(os.path.abspath(__file__))
if _here not in sys.path:
    sys.path.insert(0, _here)

from src.router import reason as root_agent
